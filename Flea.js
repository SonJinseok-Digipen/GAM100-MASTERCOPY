...
/*if(this.colfl > 0){
    if(player.bullets[i].player_attack_x >= this.flea_x && player.bullets[i].player_attack_x <= this.flea_x + this.flea_size 
    && player.bullets[i].player_attack_y == this.flea_y + this.flea_size)
}*/